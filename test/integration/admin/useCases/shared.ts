...
import { GuildConfig } from "../../../../src/infrastructure/persistence/mikroOrm/models/admin/config.ts";
import { GuildConfigLfgRole } from "../../../../src/infrastructure/persistence/mikroOrm/models/admin/configLfgRole.ts";
