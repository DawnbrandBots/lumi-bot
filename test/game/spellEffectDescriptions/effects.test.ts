...
import { SPELL_EFFECT_DESCRIPTION_FORMATTERS } from "../../../src/game/spellEffectDescriptions/effects.ts";
...
describe(SPELL_EFFECT_DESCRIPTION_FORMATTERS.WARP.name, () => {
    test("describes moving the user", () => {
        expect(SPELL_EFFECT_DESCRIPTION_FORMATTERS.WARP()).toBe("Moves user to target tile");
    });
});
