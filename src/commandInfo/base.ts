import { ApplicationIntegrationType, InteractionContextType, SharedSlashCommand, SlashCommandBuilder } from "discord.js"
...
export class CommandInfo {
    ...
    protected get baseInfo(): SlashCommandBuilder {
        return new SlashCommandBuilder().setIntegrationTypes(ApplicationIntegrationType.GuildInstall, ApplicationIntegrationType.UserInstall)
