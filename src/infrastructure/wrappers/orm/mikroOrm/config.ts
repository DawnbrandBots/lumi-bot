...
export const migrationMikroOrmConfig = defineConfig({
    ...
    dbName: STATE_DB_NAME,
    migrations: {
        path: path.join("dist", "infrastructure", "wrappers", "orm", "mikroOrm", LUMI_STATE_DB_NAME),
        pathTs: path.join("src", "infrastructure", "wrappers", "orm", "mikroOrm", LUMI_STATE_DB_NAME),
    },
    extensions: [Migrator],
});
