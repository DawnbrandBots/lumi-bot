...
export const migrationMikroOrmConfig = defineConfig({
    ...
    dbName: STATE_DB_NAME,
    migrations: {
        path: path.join("dist", "infrastructure", "persistence", "mikroOrm", "migrations", LUMI_STATE_DB_NAME),
        pathTs: path.join("src", "infrastructure", "persistence", "mikroOrm", "migrations", LUMI_STATE_DB_NAME),
    },
    extensions: [Migrator],
});
