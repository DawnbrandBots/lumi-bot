...
import type { TLeaveLfgRoomArg, TLfgUseCaseDependencies } from "../types.ts";

export async function leave(dependencies: TLfgUseCaseDependencies, { guildId, user }: TLeaveLfgRoomArg) {
