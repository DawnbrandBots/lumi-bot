...
export function composeLfgManageCommand(arg: { readonly useCases: TApplicationUseCases }) {
    const lfgManageCommandArgs = { useCases: arg.useCases } satisfies TLfgManageCommandArgs;
